export function getCarForm(car = {}) {
  ...
  <form class="mb-3 col-12 bg-white p-3 mt-4" onsubmit="app.carsController.${
    car.id ? `updateCar('${car.id}')` : "createCar()"
  }">
  <h3> ${car.id ? "Edit " + car.make : "List a car"}</h3>
                <div class="row">
                  <div class="col-3 mb-2">
                    <label for="" class="form-label">Make</label>
                    <input required type="text" name="make" id="make" value="${
                      car.make || ""
                    }" placeholder="Enter a car Make..." maxlength="15"
                      minlength="3" class="form-control" placeholder="" aria-describedby="helpId"
                      title="please enter a model">
                  </div>
                  <div class="col-3 mb-2">
                    <label for="" class="form-label">Model</label>
                    <input required type="text" name="model" id="model" value="${
                      car.model || ""
                  ...
                  <div class="col-3 mb-2">
                    ...
                    <input required type="number" name="year" id="year" value="${
                      car.year || 2000
                    }"  min="1960" max="2023"
                      class="form-control" placeholder="" aria-describedby="helpId">
                  </div>
                  <div class="col-3 mb-2">
                    ...
                    <input required type="number" name="price" id="price" value="${
                      car.price || 1
                  ...
                  <div class="col-6">
                    ...
                    <input required type="text" name="imgUrl" id="imgUrl" value="${
                      car.imgUrl || ""
                  ...
                  <div class="col-6">
                    ...
                    <input required type="color" name="color" id="color" value="${
                      car.color || "#ffffff"
                    }"  class="form-control" placeholder=""
                      aria-describedby="helpId">
                  </div>
